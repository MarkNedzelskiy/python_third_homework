...
english_alphabet = {"A": 1, "E": 1, "I": 1, "O": 1, "U": 1, "L": 1, "N": 1,
                    "S": 1, "T": 1, "R": 1, "D": 2, "G": 2, "B": 3, "C": 3,
                    "M": 3, "P": 3, "F": 4, "H": 4, "V": 4, "W": 4, "Y": 4,
                    "K": 5, "J": 8, "X": 8, "Q": 10, "Z": 10}
russian_alphabet = {"А": 1, "В": 1, "Е": 1, "И": 1, "Н": 1, "О": 1, "Р": 1, 
...
language_choose = int(input("Выберите язык игры: английский - 1, русский - 2 "))
word = input("Введите слово: ")
points = 0

for letter in word:
    if language_choose == 1:
        points += english_alphabet[letter.upper()]
    else:
        points += russian_alphabet[letter.upper()]

print(f"Вы получили {points} очков")